    ...
    for ( var regionRelativeX = 0, voxelX = this.voxelX; regionRelativeX < REGION_WIDTH; ++ regionRelativeX, ++ voxelX ) {
        for ( var regionRelativeY = 0, voxelY = this.voxelY; regionRelativeY < REGION_HEIGHT; ++ regionRelativeY, ++ voxelY ) {
            for ( var regionRelativeZ = 0, voxelZ = this.voxelZ; regionRelativeZ < REGION_DEPTH; ++ regionRelativeZ, ++ voxelZ ) {
                ...
                var voxelData = [
                    db[ [ voxelX + 0, voxelY + 0, voxelZ + 0 ].join( ',' ) ],
                    db[ [ voxelX + 1, voxelY + 0, voxelZ + 0 ].join( ',' ) ],
                    db[ [ voxelX + 1, voxelY + 1, voxelZ + 0 ].join( ',' ) ],
                    db[ [ voxelX + 0, voxelY + 1, voxelZ + 0 ].join( ',' ) ],
                    db[ [ voxelX + 0, voxelY + 0, voxelZ + 1 ].join( ',' ) ],
                    db[ [ voxelX + 1, voxelY + 0, voxelZ + 1 ].join( ',' ) ],
                    db[ [ voxelX + 1, voxelY + 1, voxelZ + 1 ].join( ',' ) ],
                    db[ [ voxelX + 0, voxelY + 1, voxelZ + 1 ].join( ',' ) ]
                ];
                ...
                for ( var l = 0, L = layers.keys.length; l < L; ++ l ) {
                    ...
                    var edgesFlagsIndex = ( 0
                        | ( cubeValues[ 0 ] !== undefined ? 1 << 0 : 0 )
                        | ( cubeValues[ 1 ] !== undefined ? 1 << 1 : 0 )
                        | ( cubeValues[ 2 ] !== undefined ? 1 << 2 : 0 )
                        | ( cubeValues[ 3 ] !== undefined ? 1 << 3 : 0 )
                        | ( cubeValues[ 4 ] !== undefined ? 1 << 4 : 0 )
                        | ( cubeValues[ 5 ] !== undefined ? 1 << 5 : 0 )
                        | ( cubeValues[ 6 ] !== undefined ? 1 << 6 : 0 )
                        | ( cubeValues[ 7 ] !== undefined ? 1 << 7 : 0 )
                    );
                    ...
                    for ( var t = 0; t < 12; ++ t ) {
                        ...
                        if ( edgesFlags & ( 1 << t ) ) {
                            ...
                            edgesVertexes[ t ] = [
                                ...
                                cubeValues[ edge[ +( cubeValues[ edge[ 0 ] ] === undefined ) ] ]
                            ];
